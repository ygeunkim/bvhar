...
#>         y1   y2   y3   y4
#>  [1,] 19.8 21.9 9.10 27.6
#>  [2,] 19.4 19.5 8.19 25.5
#>  [3,] 19.1 18.2 7.63 24.6
#>  [4,] 18.9 17.3 7.28 24.2
#>  [5,] 18.7 16.8 7.06 23.9
#>  [6,] 18.6 16.4 6.90 23.8
#>  [7,] 18.5 16.1 6.81 23.7
...
#>         y1   y2   y3   y4
#>  [1,] 19.7 20.7 8.63 26.3
#>  [2,] 19.2 18.3 7.66 24.7
#>  [3,] 18.9 17.3 7.26 24.2
#>  [4,] 18.8 16.9 7.07 24.0
#>  [5,] 18.7 16.5 6.95 23.9
#>  [6,] 18.6 16.3 6.86 23.7
#>  [7,] 18.5 16.1 6.80 23.7
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 7.36e+03 1.17e+05 1.47e+05
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.80e-01 1.16e+04 8.51e+03 1.99e+05
```
