...
#>         y1   y2    y3   y4
#>  [1,] 20.3 25.9 10.46 30.5
#>  [2,] 20.3 24.9 10.16 28.7
#>  [3,] 20.3 24.1  9.84 27.6
#>  [4,] 20.2 23.3  9.53 26.9
#>  [5,] 20.1 22.5  9.23 26.4
#>  [6,] 19.9 21.8  8.95 25.9
#>  [7,] 19.8 21.2  8.69 25.6
#>  [8,] 19.7 20.6  8.46 25.3
#>  [9,] 19.6 20.1  8.26 25.1
#> [10,] 19.5 19.6  8.08 24.9
#> [11,] 19.4 19.2  7.92 24.8
#> [12,] 19.3 18.8  7.78 24.6
#> [13,] 19.2 18.5  7.66 24.5
#> [14,] 19.1 18.2  7.55 24.4
#> [15,] 19.1 17.9  7.45 24.3
#> [16,] 19.0 17.7  7.36 24.2
#> [17,] 18.9 17.5  7.29 24.1
#> [18,] 18.9 17.3  7.22 24.1
#> [19,] 18.8 17.1  7.16 24.0
#> [20,] 18.8 17.0  7.10 24.0
```
...
#>         y1   y2   y3   y4
#>  [1,] 19.8 21.6 8.67 27.5
#>  [2,] 19.3 19.0 7.74 25.3
#>  [3,] 19.0 17.8 7.32 24.5
#>  [4,] 18.8 17.1 7.11 24.1
...
#>            y1     y2     y3    y4
#>  [1,]    20.6   20.3   8.17  26.2
#>  [2,]    22.0   18.0   7.37  24.5
#>  [3,]    24.5   17.3   7.14  24.2
#>  [4,]    28.4   17.2   7.08  24.1
#>  [5,]    34.5   17.3   7.11  24.1
#>  [6,]    44.4   17.7   7.20  24.2
#>  [7,]    60.5   18.7   7.43  24.5
#>  [8,]    86.6   20.3   7.84  25.0
#>  [9,]   128.6   23.0   8.51  25.9
#> [10,]   196.7   27.3   9.61  27.3
#> [11,]   306.9   34.4  11.39  29.5
#> [12,]   485.1   45.8  14.29  33.2
#> [13,]   773.4   64.3  18.98  39.1
#> [14,]  1239.7   94.3  26.56  48.7
#> [15,]  1994.1  142.7  38.84  64.3
#> [16,]  3214.4  221.2  58.70  89.4
#> [17,]  5188.7  348.0  90.83 130.1
#> [18,]  8382.3  553.3 142.81 195.9
#> [19,] 13548.7  885.3 226.90 302.4
#> [20,] 21906.2 1422.5 362.94 474.7
```
...
#> 3.36e+00 3.36e+00 2.77e+01 4.86e+01 9.73e+06
```
...
#>   1.000   0.966   3.141   4.576 593.832
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 2.72e+04 2.01e+05 1.29e+05
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#>     1.00     0.98 30773.41 23748.78  2325.08
```
