...
#' @param ci_param Parameter lists for \code{\link[ggplot2:geom_ribbon]{ggplot2::geom_ribbon}}. See details.
...
#' @export
plot_loss <- function(mod_list, y, type = c("mse", "mae", "mape", "mase"), ...) {
  type <- match.arg(type)
  mod_names <- 
    mod_list %>% 
