...
#' 
#' @noRd
estimate_var_sv <- function(num_chains, num_iter, num_burn, thin, x, y, param_sv, param_prior, prior_type, grp_id, grp_mat, include_mean, seed_chain, display_progress, nthreads) {
    .Call(`_bvhar_estimate_var_sv`, num_chains, num_iter, num_burn, thin, x, y, param_sv, param_prior, prior_type, grp_id, grp_mat, include_mean, seed_chain, display_progress, nthreads)
}
