...
#' 
#' @noRd
estimate_var_sv <- function(num_iter, num_burn, x, y, param_sv, param_prior, init_prior, prior_type, grp_id, grp_mat, include_mean, display_progress, nthreads) {
    .Call(`_bvhar_estimate_var_sv`, num_iter, num_burn, x, y, param_sv, param_prior, init_prior, prior_type, grp_id, grp_mat, include_mean, display_progress, nthreads)
}
