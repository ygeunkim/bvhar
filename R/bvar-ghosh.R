...
#' \item{\code{iw_scale}}{Scale matrix of posterior inverse-wishart distribution}
#' \item{\code{iw_shape}}{Shape of posterior inverse-wishart distribution}
#' 
#' @references 
...
bvar_ghosh <- function(y, p, U) {
  ...
  # Matrix normal---------------------
  posterior <- estimate_ghosh_mn(X0, Y0, U);
