...
//' @noRd
// [[Rcpp::export]]
Rcpp::List forecast_bvar(int num_chains, int var_lag, int step, Eigen::MatrixXd response_mat,
...
//' @noRd
// [[Rcpp::export]]
Rcpp::List forecast_bvharmn(int num_chains, int month, int step, Eigen::MatrixXd response_mat, Eigen::MatrixXd har_trans,
