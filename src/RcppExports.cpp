...
RcppExport SEXP _bvhar_tvp_coef(SEXP xSEXP, SEXP ySEXP, SEXP prior_meanSEXP, SEXP prior_precSEXP, SEXP innov_precSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type x(xSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(tvp_coef(x, y, prior_mean, prior_prec, innov_prec));
    return rcpp_result_gen;
END_RCPP
}
// tvp_initcoef
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bvhar_tvp_coef", (DL_FUNC) &_bvhar_tvp_coef, 5},
