...
#>         y1   y2   y3   y4
#>  [1,] 19.8 22.6 8.96 28.4
#>  [2,] 19.4 20.2 8.11 26.0
#>  [3,] 19.1 18.7 7.60 25.0
#>  [4,] 18.9 17.7 7.28 24.4
#>  [5,] 18.7 17.0 7.06 24.1
#>  [6,] 18.6 16.6 6.91 23.9
#>  [7,] 18.5 16.3 6.81 23.7
#>  [8,] 18.5 16.0 6.75 23.6
#>  [9,] 18.4 15.9 6.71 23.6
...
#>         y1   y2   y3   y4
#>  [1,] 19.9 21.3 9.57 27.3
#>  [2,] 19.6 18.9 8.71 25.2
#>  [3,] 19.3 17.8 8.10 24.4
#>  [4,] 19.1 17.2 7.68 24.1
#>  [5,] 18.9 16.8 7.39 24.0
#>  [6,] 18.8 16.5 7.18 23.8
#>  [7,] 18.7 16.3 7.04 23.7
#>  [8,] 18.6 16.2 6.93 23.7
#>  [9,] 18.6 16.1 6.86 23.7
#> [10,] 18.5 16.0 6.81 23.6
#> [11,] 18.5 15.9 6.78 23.6
#> [12,] 18.5 15.9 6.75 23.6
#> [13,] 18.5 15.9 6.73 23.6
#> [14,] 18.5 15.8 6.72 23.6
#> [15,] 18.5 15.8 6.71 23.6
#> [16,] 18.5 15.8 6.70 23.6
#> [17,] 18.5 15.8 6.69 23.5
#> [18,] 18.5 15.7 6.68 23.5
#> [19,] 18.4 15.7 6.68 23.5
#> [20,] 18.4 15.7 6.67 23.5
```
...
#>              y1        y2       y3       y4
#>  [1,]  3.56e+01  1.66e+02 6.88e+01 1.84e+02
#>  [2,]  1.19e+02  1.21e+03 5.70e+02 1.61e+03
#>  [3,]  3.73e+02  9.03e+03 5.01e+03 1.55e+04
#>  [4,] -1.93e+03  6.66e+04 4.49e+04 1.52e+05
#>  [5,] -6.63e+04  4.78e+05 4.07e+05 1.50e+06
#>  [6,] -1.07e+06  3.28e+06 3.73e+06 1.49e+07
#>  [7,] -1.42e+07  2.09e+07 3.45e+07 1.48e+08
#>  [8,] -1.73e+08  1.13e+08 3.22e+08 1.48e+09
#>  [9,] -2.02e+09  3.71e+08 3.03e+09 1.48e+10
#> [10,] -2.28e+10 -2.36e+09 2.87e+10 1.49e+11
#> [11,] -2.53e+11 -7.20e+10 2.74e+11 1.50e+12
#> [12,] -2.77e+12 -1.11e+12 2.62e+12 1.51e+13
#> [13,] -2.99e+13 -1.41e+13 2.52e+13 1.53e+14
#> [14,] -3.22e+14 -1.66e+14 2.43e+14 1.55e+15
#> [15,] -3.44e+15 -1.85e+15 2.35e+15 1.56e+16
#> [16,] -3.66e+16 -2.01e+16 2.28e+16 1.58e+17
#> [17,] -3.88e+17 -2.13e+17 2.21e+17 1.60e+18
#> [18,] -4.10e+18 -2.23e+18 2.15e+18 1.62e+19
#> [19,] -4.33e+19 -2.30e+19 2.08e+19 1.64e+20
#> [20,] -4.57e+20 -2.36e+20 2.02e+20 1.67e+21
```
...
#>       y1       y2       y3       y4 
#> 1.05e+40 2.82e+39 2.06e+39 1.40e+41
```
...
#> 3.36e+00 3.36e+00 4.80e+01 4.83e+01 3.89e+40
```
...
#> 1.00e+00 9.66e-01 4.54e+00 4.47e+00 2.29e+19
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 1.32e+04 1.25e+05 3.99e+05
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.80e-01 1.93e+04 3.90e+04 3.53e+05
```
