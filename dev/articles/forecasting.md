...
#>         y1   y2   y3   y4
#>  [1,] 20.1 21.1 10.7 26.4
#>  [2,] 20.1 19.2 10.7 25.0
#>  [3,] 20.1 18.4 10.7 24.5
#>  [4,] 20.1 17.9 10.7 24.3
#>  [5,] 20.1 17.6 10.7 24.2
#>  [6,] 20.1 17.5 10.7 24.1
#>  [7,] 20.1 17.4 10.7 24.1
#>  [8,] 20.1 17.3 10.7 24.1
#>  [9,] 20.1 17.3 10.8 24.1
#> [10,] 20.0 17.3 10.8 24.1
#> [11,] 20.0 17.3 10.8 24.1
#> [12,] 20.0 17.3 10.8 24.1
#> [13,] 20.0 17.3 10.8 24.1
#> [14,] 20.0 17.3 10.8 24.1
#> [15,] 20.0 17.3 10.9 24.1
#> [16,] 20.0 17.3 10.9 24.1
#> [17,] 20.0 17.3 10.9 24.1
#> [18,] 20.0 17.3 10.9 24.1
#> [19,] 20.0 17.3 10.9 24.1
#> [20,] 20.0 17.3 10.9 24.1
```
...
#>           y1     y2      y3    y4
#>  [1,]   20.7   19.2    12.4  25.0
#>  [2,]   21.6   17.7    15.3  24.2
#>  [3,]   23.1   17.8    20.0  24.3
#>  [4,]   25.3   18.4    27.1  24.5
#>  [5,]   28.7   19.5    38.3  24.8
#>  [6,]   33.5   21.2    55.5  25.4
#>  [7,]   40.7   24.0    82.2  26.4
#>  [8,]   51.3   28.3   123.5  28.0
#>  [9,]   66.8   34.9   187.4  30.3
#> [10,]   89.4   45.2   286.3  34.0
#> [11,]  122.3   60.9   439.4  39.5
#> [12,]  170.1   85.1   676.2  48.1
#> [13,]  239.3  122.2  1042.8  61.3
#> [14,]  338.8  179.3  1610.4  81.6
#> [15,]  481.3  267.0  2489.0 112.8
#> [16,]  684.4  401.7  3849.6 160.8
#> [17,]  971.7  608.8  5956.5 234.5
#> [18,] 1375.0  927.0  9219.6 348.0
#> [19,] 1935.7 1416.1 14273.9 522.5
#> [20,] 2706.0 2168.0 22103.3 791.0
```
...
#>             y1        y2       y3       y4
#>  [1,] 2.40e+01  2.88e+01 7.87e+00 2.57e+01
#>  [2,] 3.99e+01  2.92e+01 7.41e+00 2.44e+01
#>  [3,] 1.02e+02  2.94e+01 7.52e+00 2.45e+01
#>  [4,] 3.42e+02  2.96e+01 8.32e+00 2.55e+01
#>  [5,] 1.28e+03  2.96e+01 1.16e+01 2.97e+01
#>  [6,] 4.91e+03  2.91e+01 2.42e+01 4.60e+01
#>  [7,] 1.90e+04  2.68e+01 7.33e+01 1.10e+02
#>  [8,] 7.40e+04  1.76e+01 2.65e+02 3.58e+02
#>  [9,] 2.88e+05 -1.92e+01 1.01e+03 1.32e+03
#> [10,] 1.12e+06 -1.63e+02 3.90e+03 5.07e+03
#> [11,] 4.35e+06 -7.21e+02 1.52e+04 1.97e+04
#> [12,] 1.69e+07 -2.89e+03 5.90e+04 7.64e+04
#> [13,] 6.59e+07 -1.13e+04 2.29e+05 2.97e+05
#> [14,] 2.56e+08 -4.42e+04 8.92e+05 1.16e+06
#> [15,] 9.97e+08 -1.72e+05 3.47e+06 4.50e+06
#> [16,] 3.88e+09 -6.70e+05 1.35e+07 1.75e+07
#> [17,] 1.51e+10 -2.60e+06 5.25e+07 6.81e+07
#> [18,] 5.87e+10 -1.01e+07 2.04e+08 2.65e+08
#> [19,] 2.28e+11 -3.94e+07 7.95e+08 1.03e+09
#> [20,] 8.88e+11 -1.53e+08 3.09e+09 4.01e+09
```
...
#>       y1       y2       y3       y4 
#> 4.22e+22 1.26e+15 5.12e+17 8.59e+17
```
...
#> 3.36e+00 3.36e+00 3.72e+01 1.08e+07 1.06e+22
```
...
#> 1.00e+00 9.66e-01 3.01e+00 1.40e+03 1.10e+10
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 1.96e+04 2.54e+05 3.48e+04
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#>     1.00     0.98 33374.27 37607.77  5021.15
```
