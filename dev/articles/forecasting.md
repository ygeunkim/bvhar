...
#>          y1    y2     y3   y4
#>  [1,]  20.4  21.9   11.6 27.1
#>  [2,]  20.8  19.6   13.1 25.2
#>  [3,]  21.4  18.5   15.2 24.6
#>  [4,]  22.4  17.9   18.3 24.3
#>  [5,]  23.7  17.7   22.4 24.2
#>  [6,]  25.4  17.8   28.1 24.3
#>  [7,]  27.7  18.2   35.9 24.4
#>  [8,]  30.8  18.9   46.5 24.7
#>  [9,]  35.0  20.0   61.0 25.1
#> [10,]  40.4  21.4   80.8 25.6
#> [11,]  47.7  23.5  107.7 26.3
#> [12,]  57.3  26.2  144.5 27.3
#> [13,]  70.1  30.0  194.7 28.7
#> [14,]  87.0  35.1  263.1 30.6
#> [15,] 109.3  42.1  356.4 33.1
#> [16,] 138.9  51.6  483.7 36.6
#> [17,] 178.0  64.4  657.3 41.3
#> [18,] 229.6  81.9  894.1 47.6
#> [19,] 297.6 105.6 1217.1 56.3
#> [20,] 387.3 137.8 1657.9 68.0
```
...
#>         y1   y2   y3   y4
#>  [1,] 20.0 26.6 10.7 33.8
#>  [2,] 20.0 26.3 10.7 33.3
#>  [3,] 19.9 26.0 10.7 32.8
#>  [4,] 19.9 25.8 10.6 32.4
#>  [5,] 19.8 25.6 10.6 32.0
#>  [6,] 19.8 25.5 10.6 31.7
#>  [7,] 19.7 25.3 10.5 31.4
#>  [8,] 19.7 25.2 10.5 31.1
#>  [9,] 19.7 25.0 10.5 30.8
#> [10,] 19.6 24.9 10.5 30.6
#> [11,] 19.6 24.8 10.4 30.3
#> [12,] 19.6 24.7 10.4 30.1
#> [13,] 19.6 24.6 10.4 29.9
#> [14,] 19.5 24.5 10.3 29.7
#> [15,] 19.5 24.4 10.3 29.5
#> [16,] 19.5 24.4 10.3 29.4
#> [17,] 19.5 24.3 10.3 29.2
#> [18,] 19.5 24.3 10.2 29.1
#> [19,] 19.5 24.2 10.2 28.9
#> [20,] 19.5 24.1 10.2 28.8
```
...
#>         y1   y2   y3   y4
#>  [1,] 19.3 19.4 7.79 25.8
#>  [2,] 18.8 17.2 7.10 24.3
#>  [3,] 18.6 16.6 6.90 23.9
#>  [4,] 18.6 16.3 6.82 23.8
#>  [5,] 18.5 16.1 6.77 23.7
#>  [6,] 18.5 15.9 6.72 23.6
#>  [7,] 18.5 15.9 6.70 23.6
#>  [8,] 18.5 15.8 6.69 23.6
#>  [9,] 18.4 15.8 6.68 23.6
#> [10,] 18.4 15.8 6.68 23.6
#> [11,] 18.4 15.8 6.67 23.6
#> [12,] 18.4 15.7 6.67 23.6
...
list(
  ...
  unlist() |> 
  sort()
#>     VHAR      VAR   BVHAR1   BVHAR2     BVAR 
#>     3.36     3.36     3.78    51.65 77196.74
```
...
#>   1.000   0.966 142.528   1.036   4.750
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 2.31e+04 1.13e+05 3.40e+04
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#>     1.00     0.98   482.12  2409.82 21227.26
```
