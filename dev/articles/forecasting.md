...
#>         y1   y2   y3   y4
#>  [1,] 19.9 22.3 9.05 27.9
#>  [2,] 19.5 19.9 8.16 25.7
#>  [3,] 19.2 18.5 7.63 24.8
#>  [4,] 18.9 17.6 7.29 24.3
#>  [5,] 18.7 16.9 7.06 24.0
#>  [6,] 18.6 16.5 6.91 23.8
#>  [7,] 18.5 16.2 6.81 23.7
...
#>         y1   y2   y3   y4
#>  [1,] 20.3 21.1 11.1 27.1
#>  [2,] 20.4 18.9 11.6 25.1
#>  [3,] 20.6 18.2 12.2 24.5
#>  [4,] 20.8 18.0 13.0 24.4
#>  [5,] 21.1 18.0 13.8 24.3
#>  [6,] 21.3 18.1 14.8 24.4
#>  [7,] 21.7 18.3 15.9 24.4
#>  [8,] 22.0 18.5 17.2 24.5
#>  [9,] 22.4 18.8 18.6 24.6
#> [10,] 22.8 19.2 20.3 24.8
#> [11,] 23.3 19.7 22.1 24.9
#> [12,] 23.8 20.2 24.3 25.1
#> [13,] 24.3 20.7 26.7 25.3
#> [14,] 24.9 21.4 29.4 25.5
#> [15,] 25.6 22.1 32.5 25.8
#> [16,] 26.3 23.0 36.1 26.1
#> [17,] 27.0 23.9 40.2 26.4
#> [18,] 27.9 25.0 44.8 26.8
#> [19,] 28.8 26.2 50.0 27.2
#> [20,] 29.8 27.6 56.0 27.7
```
...
#>              y1       y2       y3      y4
#>  [1,]  2.09e+01     20.1 1.72e+01    26.8
#>  [2,]  2.28e+01     19.1 2.93e+01    25.4
#>  [3,]  2.57e+01     20.5 5.17e+01    25.6
#>  [4,]  2.98e+01     24.1 9.42e+01    26.7
#>  [5,]  3.46e+01     31.1 1.76e+02    28.9
#>  [6,]  3.88e+01     44.4 3.33e+02    33.3
#>  [7,]  3.69e+01     69.9 6.36e+02    41.9
#>  [8,]  1.45e+01    118.3 1.22e+03    58.1
#>  [9,] -6.50e+01    210.0 2.35e+03    89.1
#> [10,] -2.87e+02    383.9 4.54e+03   147.8
#> [11,] -8.49e+02    713.6 8.76e+03   259.5
#> [12,] -2.19e+03   1339.4 1.69e+04   471.9
#> [13,] -5.25e+03   2527.6 3.28e+04   875.9
#> [14,] -1.21e+04   4784.8 6.34e+04  1645.1
#> [15,] -2.71e+04   9075.4 1.23e+05  3110.4
#> [16,] -5.94e+04  17235.5 2.38e+05  5903.3
#> [17,] -1.28e+05  32764.2 4.62e+05 11229.8
#> [18,] -2.74e+05  62332.3 8.96e+05 21394.9
#> [19,] -5.80e+05 118666.5 1.74e+06 40806.0
#> [20,] -1.22e+06 226061.9 3.38e+06 77896.3
```
...
#>       y1       y2       y3       y4 
#> 9.56e+10 3.53e+09 7.77e+11 4.18e+08
```
...
#> 3.36e+00 3.36e+00 4.85e+01 1.24e+02 2.19e+11
```
...
#> 1.00e+00 9.66e-01 4.55e+00 8.83e+00 1.64e+05
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 1.09e+03 2.45e+05 1.04e+05
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#>     1.00     0.98   199.07 26525.14  8272.92
```
