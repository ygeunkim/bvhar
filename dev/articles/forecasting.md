...
#>         y1   y2   y3   y4
#>  [1,] 19.8 21.8 9.21 25.9
#>  [2,] 19.4 19.4 8.26 24.8
#>  [3,] 19.1 18.1 7.67 24.3
#>  [4,] 18.9 17.2 7.31 24.0
#>  [5,] 18.7 16.7 7.07 23.8
#>  [6,] 18.6 16.3 6.91 23.7
#>  [7,] 18.5 16.1 6.81 23.6
#>  [8,] 18.5 15.9 6.75 23.6
#>  [9,] 18.4 15.8 6.71 23.6
#> [10,] 18.4 15.8 6.69 23.5
#> [11,] 18.4 15.7 6.67 23.5
...
#>         y1   y2    y3   y4
#>  [1,] 20.1 21.7 10.55 27.7
#>  [2,] 20.1 19.4 10.44 25.4
#>  [3,] 20.0 18.4 10.33 24.7
#>  [4,] 20.0 17.9 10.22 24.4
#>  [5,] 19.9 17.6 10.11 24.2
#>  [6,] 19.9 17.3 10.00 24.1
#>  [7,] 19.8 17.2  9.90 24.0
#>  [8,] 19.8 17.1  9.80 24.0
#>  [9,] 19.8 17.0  9.70 24.0
#> [10,] 19.7 17.0  9.61 24.0
#> [11,] 19.7 16.9  9.51 23.9
#> [12,] 19.6 16.9  9.42 23.9
#> [13,] 19.6 16.8  9.34 23.9
#> [14,] 19.6 16.8  9.25 23.9
#> [15,] 19.5 16.8  9.17 23.9
#> [16,] 19.5 16.7  9.09 23.9
#> [17,] 19.5 16.7  9.02 23.9
#> [18,] 19.4 16.6  8.94 23.8
#> [19,] 19.4 16.6  8.87 23.8
#> [20,] 19.4 16.6  8.80 23.8
```
...
#>         y1     y2    y3   y4
#>  [1,] 19.7   32.0  8.24 26.3
#>  [2,] 19.4   37.9  7.65 24.8
#>  [3,] 19.4   44.5  7.59 24.5
#>  [4,] 19.4   52.3  7.68 24.6
#>  [5,] 19.4   61.9  7.84 24.7
#>  [6,] 19.5   74.0  8.06 24.8
#>  [7,] 19.6   89.1  8.38 25.1
#>  [8,] 19.8  107.8  8.80 25.4
#>  [9,] 20.1  131.0  9.32 25.9
#> [10,] 20.4  159.8  9.97 26.5
#> [11,] 20.9  195.7 10.78 27.2
#> [12,] 21.5  240.4 11.80 28.1
#> [13,] 22.2  296.2 13.06 29.2
#> [14,] 23.1  365.8 14.64 30.5
#> [15,] 24.3  452.5 16.62 32.3
#> [16,] 25.7  560.7 19.08 34.4
#> [17,] 27.5  695.7 22.15 37.1
#> [18,] 29.7  864.0 25.99 40.5
#> [19,] 32.5 1074.0 30.77 44.7
#> [20,] 35.9 1336.0 36.74 49.9
```
...
#>     3.36     3.36    39.60    49.67 58917.88
```
...
#>  1.000  0.966  4.593  3.195 52.452
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 9.49e+03 3.81e+04 7.35e+04
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#>     1.00     0.98 33090.30   894.59 13939.66
```
