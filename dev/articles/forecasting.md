...
#>         y1   y2   y3   y4
#>  [1,] 20.2 21.4 10.9 26.9
#>  [2,] 20.3 19.4 11.3 25.2
#>  [3,] 20.4 18.6 11.7 24.6
#>  [4,] 20.5 18.2 12.1 24.4
#>  [5,] 20.7 18.0 12.7 24.3
#>  [6,] 20.8 18.0 13.2 24.3
#>  [7,] 21.0 18.1 13.9 24.3
#>  [8,] 21.2 18.2 14.5 24.4
#>  [9,] 21.4 18.4 15.3 24.5
#> [10,] 21.6 18.7 16.1 24.6
#> [11,] 21.8 18.9 17.0 24.7
#> [12,] 22.1 19.2 18.0 24.8
#> [13,] 22.3 19.6 19.1 24.9
#> [14,] 22.6 19.9 20.3 25.0
#> [15,] 22.9 20.3 21.6 25.1
#> [16,] 23.2 20.7 23.1 25.3
#> [17,] 23.5 21.2 24.7 25.5
#> [18,] 23.8 21.7 26.4 25.6
#> [19,] 24.2 22.3 28.3 25.8
#> [20,] 24.6 22.9 30.4 26.1
```
...
#>         y1   y2   y3   y4
#>  [1,] 19.7 21.6 8.71 25.9
#>  [2,] 19.2 18.9 7.71 24.6
#>  [3,] 18.9 17.6 7.29 24.2
#>  [4,] 18.8 17.0 7.08 24.0
#>  [5,] 18.7 16.6 6.96 23.9
#>  [6,] 18.6 16.3 6.86 23.7
#>  [7,] 18.5 16.2 6.80 23.7
#>  [8,] 18.5 16.1 6.77 23.6
#>  [9,] 18.5 16.0 6.75 23.6
#> [10,] 18.5 15.9 6.73 23.6
#> [11,] 18.5 15.9 6.72 23.6
#> [12,] 18.5 15.9 6.71 23.6
#> [13,] 18.5 15.8 6.70 23.6
#> [14,] 18.5 15.8 6.70 23.6
#> [15,] 18.5 15.8 6.69 23.6
#> [16,] 18.4 15.8 6.69 23.6
#> [17,] 18.4 15.8 6.68 23.5
#> [18,] 18.4 15.8 6.67 23.5
#> [19,] 18.4 15.7 6.67 23.5
#> [20,] 18.4 15.7 6.66 23.5
```
...
#>             y1       y2       y3       y4
#>  [1,] 3.75e+01 1.87e+01 7.54e+00 2.52e+01
#>  [2,] 2.31e+02 1.71e+01 7.03e+00 2.40e+01
#>  [3,] 2.36e+03 2.03e+01 7.86e+00 2.51e+01
#>  [4,] 2.57e+04 6.09e+01 1.84e+01 3.87e+01
#>  [5,] 2.82e+05 5.08e+02 1.35e+02 1.89e+02
#>  [6,] 3.09e+06 5.42e+03 1.42e+03 1.84e+03
#>  [7,] 3.40e+07 5.93e+04 1.55e+04 1.99e+04
#>  [8,] 3.73e+08 6.51e+05 1.70e+05 2.18e+05
#>  [9,] 4.09e+09 7.14e+06 1.86e+06 2.40e+06
#> [10,] 4.49e+10 7.84e+07 2.04e+07 2.63e+07
#> [11,] 4.93e+11 8.60e+08 2.24e+08 2.89e+08
#> [12,] 5.41e+12 9.44e+09 2.46e+09 3.17e+09
#> [13,] 5.93e+13 1.04e+11 2.70e+10 3.48e+10
#> [14,] 6.51e+14 1.14e+12 2.97e+11 3.81e+11
#> [15,] 7.15e+15 1.25e+13 3.25e+12 4.19e+12
#> [16,] 7.84e+16 1.37e+14 3.57e+13 4.59e+13
#> [17,] 8.61e+17 1.50e+15 3.92e+14 5.04e+14
#> [18,] 9.45e+18 1.65e+16 4.30e+15 5.53e+15
#> [19,] 1.04e+20 1.81e+17 4.72e+16 6.07e+16
#> [20,] 1.14e+21 1.99e+18 5.18e+17 6.66e+17
```
...
#>       y1       y2       y3       y4 
#> 6.53e+40 1.99e+35 1.35e+34 2.24e+34
```
...
#> 3.36e+00 3.36e+00 4.85e+01 4.93e+01 1.63e+40
```
...
#> 1.00e+00 9.66e-01 5.61e+00 4.60e+00 1.12e+19
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 3.47e+04 4.41e+04 4.78e+04
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#>     1.00     0.98  4224.01 47130.22 48034.12
```
