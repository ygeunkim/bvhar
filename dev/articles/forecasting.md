...
#>         y1   y2   y3   y4
#>  [1,] 19.9 22.3 9.31 27.9
#>  [2,] 19.6 20.0 8.42 25.7
#>  [3,] 19.3 18.6 7.83 24.8
#>  [4,] 19.0 17.7 7.44 24.3
#>  [5,] 18.8 17.0 7.17 24.0
#>  [6,] 18.7 16.6 6.99 23.8
...
#>         y1   y2   y3   y4
#>  [1,] 19.8 21.5 9.29 27.3
#>  [2,] 19.4 19.0 8.35 25.2
#>  [3,] 19.2 17.8 7.76 24.4
#>  [4,] 19.0 17.2 7.40 24.1
#>  [5,] 18.8 16.8 7.17 23.9
#>  [6,] 18.7 16.4 7.01 23.8
#>  [7,] 18.6 16.2 6.91 23.7
#>  [8,] 18.6 16.1 6.84 23.7
#>  [9,] 18.5 16.0 6.79 23.6
#> [10,] 18.5 16.0 6.76 23.6
#> [11,] 18.5 15.9 6.74 23.6
#> [12,] 18.5 15.9 6.72 23.6
#> [13,] 18.5 15.8 6.71 23.6
#> [14,] 18.5 15.8 6.70 23.6
#> [15,] 18.5 15.8 6.70 23.6
#> [16,] 18.5 15.8 6.69 23.5
#> [17,] 18.4 15.8 6.68 23.5
#> [18,] 18.4 15.7 6.68 23.5
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#> 1.00e+00 9.87e-01 8.52e+03 6.69e+04 1.31e+05
```
...
list(
  ...
  unlist()
#>      VAR     VHAR     BVAR   BVHAR1   BVHAR2 
#>     1.00     0.98 17213.10  8089.97 71921.39
```
