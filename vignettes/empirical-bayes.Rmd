...
BVHAR-S (Anonymous. (n.d.)) has the same set of hyperparameters with BVAR.
...
- Based on this calculation, Anonymous. (n.d.) gives the closed form for BVHAR-S and BVHAR-L.
