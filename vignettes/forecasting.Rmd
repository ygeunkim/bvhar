...
# fit---------------------------------------
model_bvar <- bvar_minnesota(y_train, 5, num_iter = 10, bayes_spec = spec_bvar)
```
...
# fit---------------------------------------
model_bvhar_v1 <- bvhar_minnesota(y_train, num_iter = 10, bayes_spec = spec_bvhar_v1)
```
...
# fit--------------------------------------
model_bvhar_v2 <- bvhar_minnesota(y_train, num_iter = 10, bayes_spec = spec_bvhar_v2)
```
