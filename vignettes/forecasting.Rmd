...
# fit---------------------------------------
model_bvar <- bvar_minnesota(y_train, 5, y_sig, y_lam, y_delta, eps)
```
...
```{r}
model_bvhar_v1 <- bvhar_minnesota(
  y_train, mn_type = "VAR", y_sig, y_lam, y_delta
)
```
...
y_month <- rep(.1, m)
# fit--------------------------------------
model_bvhar_v2 <- bvhar_minnesota(
  y_train, 
  mn_type = "VHAR", 
  sigma = y_sig, 
  lambda = y_lam, 
