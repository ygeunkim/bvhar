...
title: "Forecasting"
description: >
  See how to forecast multivariate time series
  using this package.
...
etf_eval <- 
  etf_vix %>% 
  select(GVZCLS, OVXCLS, EVZCLS, VXFXICLS) %>% 
  divide_ts(19)
