...
echo "EIGEN_INCLUDE_DIR=/usr/include/eigen3" >> ~/.bashrc
echo "BOOST_INCLUDE_DIR=/usr/include/boost" >> ~/.bashrc
source ~/.bashrc
```
...
echo "EIGEN_INCLUDE_DIR=$(brew --prefix eigen)/include/eigen3" >> ~/.zshrc
echo "BOOST_INCLUDE_DIR=$(brew --prefix boost)/include" >> ~/.zshrc
source ~/.zshrc
```
...
Get-ChildItem $env:EIGEN_INCLUDE_DIR
$env:BOOST_INCLUDE_DIR
Get-ChildItem $env:BOOST_INCLUDE_DIR
```
